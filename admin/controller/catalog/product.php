...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
        ...
        $product_image_angles = $this->model_catalog_product->getImageAngles();
        $product_image_colors = $this->model_catalog_product->getImageColors();

        $data['angles'] = $product_image_angles;
        $data['colors'] = $product_image_colors;
		...
		foreach ($product_images as $product_image) {
			...
			$data['product_images'][] = array(
				...
				'angle_id' => $product_image['angle_id'],
